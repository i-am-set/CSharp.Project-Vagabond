...
namespace ProjectVagabond
{
    ...
    public class ItemManager
    {
        ...
        public void LoadWeapons(string directoryPath)
        {
            ...
            {
                Console.WriteLine($"[ERROR] Weapon directory not found: {directoryPath}");
                return;
            }
            ...
            var jsonOptions = new JsonSerializerOptions
            {
                ...
                Converters = { new JsonStringEnumConverter() } // Important for WeaponType enum
            };
            ...
            foreach (var file in weaponFiles)
            {
                try
                {
                    ...
                    if (weapon != null && !string.IsNullOrEmpty(weapon.Id))
                    {
                        ...
                        Console.WriteLine($"[INFO] Loaded weapon: {weapon.Id}");
                    }
                    else
                    {
