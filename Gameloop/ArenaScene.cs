    ...
    public class ArenaScene : GameScene
    {
        ...
        private void InitializePauseMenu()
        {
            ...
            resumeBtn.OnClick += () => {
                ...
                ServiceLocator.Get<ProjectVagabond.Audio.AudioManager>().PlayRoutedSfx("proc:wave=2;atk=0.02;sus=0.05;dec=0.2;freq=880;slide=-440;detune=0.01;delay=0.05;delfb=0.15;vol=0.2");
            };
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (_arenaState == ArenaState.Betting)
            {
                ...
                if (currentSecond != _lastCountdownSecond && currentSecond > 0)
                {
                    ...
                    if (currentSecond <= 3)
                    {
                        ServiceLocator.Get<ProjectVagabond.Audio.AudioManager>().PlayRoutedSfx("proc:wave=2;atk=0.01;sus=0.05;dec=0.1;freq=600;detune=0.01;delay=0.05;delfb=0.15;vol=0.15|wave=2;atk=0.01;sus=0.05;dec=0.2;freq=150;vol=0.25");
                        ServiceLocator.Get<HapticsManager>().TriggerZoomPulse(1.01f, 0.1f);
                    }
                    else if (currentSecond <= 10)
                    {
                        ServiceLocator.Get<ProjectVagabond.Audio.AudioManager>().PlayRoutedSfx("proc:wave=2;atk=0.01;sus=0.05;dec=0.1;freq=600;detune=0.01;delay=0.04;delfb=0.1;vol=0.05");
                    }
                }
            ...
            if (_inputManager.Back)
            {
                ...
                ServiceLocator.Get<ProjectVagabond.Audio.AudioManager>().PlayRoutedSfx("proc:wave=2;atk=0.02;sus=0.05;dec=0.2;freq=440;slide=440;detune=0.01;delay=0.05;delfb=0.15;vol=0.2");
            }
