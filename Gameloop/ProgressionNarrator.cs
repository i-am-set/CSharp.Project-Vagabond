...
{
    /// <summary>
    /// Manages the display and flow of narrative text for the main game progression,
    /// similar to the BattleNarrator but for the overworld/gauntlet loop.
    /// </summary>
    public class ProgressionNarrator
    {
        ...
        public ProgressionNarrator(Rectangle bounds)
        {
        ...
        public void Show(string message, BitmapFont font)
        {
            ...
            if (_messageQueue.Count > 0 && !IsBusy)
            {
                ProcessNextSegment();
            }
        }
        ...
        /// <summary>
        /// Immediately clears all current and queued messages from the narrator.
        /// </summary>
        public void Clear()
        {
            _messageQueue.Clear();
