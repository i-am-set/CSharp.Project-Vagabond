...
namespace ProjectVagabond.Scenes
{
    public class ScoundrelScene : GameScene
    {
        ...
        private void InitializeUI()
        {
            ...
            _skipButton = new Button(new Rectangle(Global.VIRTUAL_WIDTH / 2 - skipW / 2, 29, skipW, skipH), "SKIP ROOM", font: defFont);
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (_state == ScoundrelState.Dealing)
            {
                ...
                if (_dealTimer <= 0f && _room.Count < 4 && _deck.Count > 0)
                {
                    ...
                    ServiceLocator.Get<ProjectVagabond.Audio.AudioManager>().PlayRoutedSfx("proc:wave=2;freq=300;slide=300;atk=0.01;sus=0.02;dec=0.08;detune=0.01;vol=0.03");
                }
                else if (_room.Count == 4 || _deck.Count == 0)
                {
                    if (_state == ScoundrelState.Dealing)
                    {
                        ServiceLocator.Get<ProjectVagabond.Audio.AudioManager>().PlayRoutedSfx("proc:wave=2;freq=400;atk=0.05;sus=0.1;dec=0.3;detune=0.01;delay=0.1;delfb=0.2;vol=0.03|wave=2;freq=600;atk=0.05;sus=0.1;dec=0.3;detune=0.01;vol=0.03");
            ...
            else if (_state == ScoundrelState.GameOver)
            {
                if (_scoreAnimTimer < 3.0f)
                {
                    ...
                    if (newScore != _displayScore)
                    {
                        ...
                        ServiceLocator.Get<ProjectVagabond.Audio.AudioManager>().PlayRoutedSfx($"proc:wave=2;freq={400 + p * 800};atk=0.01;sus=0;dec=0.05;detune=0.01;vol=0.02");
                    }

                    if (p >= 1f && !_scoreSlamPlayed)
                    {
                        _displayScore = _targetScore;
                        ServiceLocator.Get<ProjectVagabond.Audio.AudioManager>().PlayRoutedSfx("proc:wave=4;freq=100;slide=-50;atk=0.01;sus=0.1;dec=0.4;detune=0.03;lpf=800;vol=0.08|wave=5;freq=200;atk=0.01;sus=0.1;dec=0.3;lpf=500;vol=0.06");
        ...
        private void OnSkipClicked()
        {
            ...
            ServiceLocator.Get<ProjectVagabond.Audio.AudioManager>().PlayRoutedSfx("proc:wave=4;freq=300;slide=-150;atk=0.02;sus=0.05;dec=0.2;detune=0.02;lpf=2000;vol=0.04");
        }
        ...
        private void OnWeaponClicked()
        {
            if (_focusedCard.Value >= _lastSlainValue)
            {
                ...
                ServiceLocator.Get<ProjectVagabond.Audio.AudioManager>().PlayRoutedSfx("proc:wave=4;freq=200;slide=-100;atk=0.01;sus=0.05;dec=0.15;detune=0.03;lpf=1000;vol=0.04");
                return;
            }
            ...
            {
                ServiceLocator.Get<ProjectVagabond.Audio.AudioManager>().PlayRoutedSfx("proc:wave=4;freq=150;slide=-75;atk=0.01;sus=0.05;dec=0.15;detune=0.02;lpf=1200;vol=0.05");
            }
        ...
        private void ApplyDamage(int amount)
        {
            ...
            ServiceLocator.Get<ProjectVagabond.Audio.AudioManager>().PlayRoutedSfx("proc:wave=1;freq=150;slide=-100;atk=0.01;sus=0.05;dec=0.25;detune=0.03;lpf=1500;vol=0.06|wave=5;freq=400;slide=-200;atk=0.01;sus=0.05;dec=0.2;lpf=1000;vol=0.04");
        ...
        private async void PlayHealFull()
        {
            ...
            audio.PlayRoutedSfx("proc:wave=2;freq=400;atk=0.02;sus=0.05;dec=0.15;detune=0.01;delay=0.05;delfb=0.15;vol=0.04");
            await Task.Delay(100);
            audio.PlayRoutedSfx("proc:wave=2;freq=600;atk=0.02;sus=0.05;dec=0.15;detune=0.01;delay=0.05;delfb=0.15;vol=0.04");
            await Task.Delay(200);
            audio.PlayRoutedSfx("proc:wave=2;freq=800;atk=0.02;sus=0.05;dec=0.25;detune=0.01;delay=0.05;delfb=0.15;vol=0.04");
        }

        private async void PlayHealPartial()
        {
            var audio = ServiceLocator.Get<ProjectVagabond.Audio.AudioManager>();
            audio.PlayRoutedSfx("proc:wave=2;freq=400;atk=0.02;sus=0.05;dec=0.15;detune=0.01;vol=0.04");
            await Task.Delay(100);
            audio.PlayRoutedSfx("proc:wave=2;freq=600;atk=0.02;sus=0.05;dec=0.2;detune=0.01;vol=0.04");
        }

        private async void PlayDefeatSequence()
        {
            var audio = ServiceLocator.Get<ProjectVagabond.Audio.AudioManager>();
            audio.PlayRoutedSfx("proc:wave=4;freq=300;atk=0.05;sus=0.1;dec=0.3;detune=0.02;lpf=2000;vol=0.05");
            await Task.Delay(300);
            audio.PlayRoutedSfx("proc:wave=4;freq=250;atk=0.05;sus=0.1;dec=0.3;detune=0.02;lpf=2000;vol=0.05");
            await Task.Delay(600);
            audio.PlayRoutedSfx("proc:wave=4;freq=200;atk=0.05;sus=0.2;dec=0.6;detune=0.02;lpf=2000;vol=0.05");
        }

        private async void PlayVictorySequence()
        {
            var audio = ServiceLocator.Get<ProjectVagabond.Audio.AudioManager>();
            audio.PlayRoutedSfx("proc:wave=0;freq=400;atk=0.02;sus=0.1;dec=0.2;detune=0.01;lpf=3000;vol=0.04");
            await Task.Delay(200);
            audio.PlayRoutedSfx("proc:wave=0;freq=500;atk=0.02;sus=0.1;dec=0.2;detune=0.01;lpf=3000;vol=0.04");
            await Task.Delay(400);
            audio.PlayRoutedSfx("proc:wave=0;freq=600;atk=0.02;sus=0.1;dec=0.2;detune=0.01;lpf=3000;vol=0.04");
            await Task.Delay(600);
            audio.PlayRoutedSfx("proc:wave=0;freq=800;atk=0.02;sus=0.2;dec=0.6;detune=0.01;lpf=3000;vol=0.04");
        }
        ...
        private void ApplyHeal(int amount)
        {
            ...
            if (actualHeal == 0)
            {
                ServiceLocator.Get<ProjectVagabond.Audio.AudioManager>().PlayRoutedSfx("proc:wave=2;freq=300;slide=-50;atk=0.02;sus=0.05;dec=0.15;detune=0.01;vol=0.04");
            }
            else if (_health == 20)
            {
                PlayHealFull();
        ...
        private void EquipWeapon(Card weapon)
        {
            ...
            ServiceLocator.Get<ProjectVagabond.Audio.AudioManager>().PlayRoutedSfx("proc:wave=4;freq=600;slide=400;atk=0.01;sus=0.05;dec=0.15;detune=0.02;lpf=3000;vol=0.04|wave=2;freq=1200;slide=200;atk=0.01;sus=0.05;dec=0.1;vol=0.02");
        }
        ...
        private void MoveToDiscard(Card card, bool playSound = true)
        {
            ...
            if (playSound)
            {
                ServiceLocator.Get<ProjectVagabond.Audio.AudioManager>().PlayRoutedSfx("proc:wave=2;freq=250;slide=-100;atk=0.01;sus=0.02;dec=0.1;detune=0.01;vol=0.03");
            }
        }
