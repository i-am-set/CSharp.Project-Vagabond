...
namespace ProjectVagabond
{
    public class Core : Game
    {
        ...
        private void DrawTerminal()
        {
            ...
            if (inputDisplay.Length > TERMINAL_WIDTH_CHARS)
            {
                inputDisplay = inputDisplay.Substring(0, TERMINAL_WIDTH_CHARS - 3) + "...";
            }
            _spriteBatch.DrawString(_font, inputDisplay, new Vector2(terminalX, inputLineY), Color.Yellow);
            ...
            _spriteBatch.DrawString(_font, statusText, new Vector2(terminalX, statusY), Color.Cyan);
        }
    }
